...
function CryptoDetails() {
    ...
    const { data: cryptoHistoryResult } = useGetCryptoHistoryQuery({ coinId, timePeriod })
    ...
    const stats = [
        ...
        { title: '24h Volume', value: `$ ${cryptoDetails[`24hVolume`] && millify(parseInt(cryptoDetails[`24hVolume`]))}`, icon: <ThunderboltOutlined /> },
    ...
    const genericStats = [
        ...
        { title: 'Circulating Supply', value: `$ ${millify(parseInt(cryptoDetails.supply.circulating))}`, icon: <ExclamationCircleOutlined /> },
    ];
    ...
    return (
        <Col className='coin-detail-container'>
            ...
            <LineChart coinHistory={cryptoHistory} currentPrice={millify(cryptoDetails.price)} coinName={cryptoDetails.name}></LineChart>
